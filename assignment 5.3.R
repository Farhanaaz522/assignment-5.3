...
airquality = read.csv("C:/Users/mudassar/Desktop/farha/AirQuality.csv")
#then view our file
View(airquality)

#2
#Univariate analysis is the simplest form of analyzing data. "Uni" means "one", 
#so in other words the data has only one variable
...
new_day=(airquality$Day)
new_day

str(airquality)


data = ts(airquality$Day,frequency =12)

plot(data,main="airquality")
